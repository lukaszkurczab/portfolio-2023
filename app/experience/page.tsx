...
import fitaly from "../../public/fitaly.jpg";
  ...
  return (
    <main className={styles.landingPage}>
      ...
      <div className={styles.projects__group}>
        ...
        <div className={styles.projectsTiles}>
          <a
            href="https://quizapp-lkurczab.netlify.app/"
            className={styles.project__tile}
          >
          ...
          <a href="/fitaly" className={styles.project__tile}>
            <Image
              src={fitaly}
              alt="Fitaly"
              className={styles.project__tileImage}
            />
            <div className={styles.project__tileTextWrapper}>
              <h3 className={styles.project__tileName}>Fitaly</h3>
      ...
      <div className={styles.projects__group}>
        ...
        <div className={styles.projectsTiles}>
          <a
            href="https://booking-lkurczab.netlify.app/"
            className={styles.project__tile}
          >
            ...
            <div className={styles.project__tileTextWrapper}>
              ...
              <h2 className={styles.project__tileDesc}>
                Mapping an existing page
              </h2>
            </div>
          </a>
          <a
            href="https://portfolio-lkurczab.netlify.app/"
            className={styles.project__tile}
          >
            <Image
              src={portfolio}
          ...
          <a
            href="https://youtube-lkurczab.netlify.app/"
            className={styles.project__tile}
          >
          ...
          <a
            href="https://fylo-lkurczab.netlify.app/"
            className={styles.project__tile}
          >
          ...
          <a
            href="https://social-media-dashboard-lkurczab.netlify.app/"
            className={styles.project__tile}
          >
            <Image
              src={socialMedia}
            ...
            />
            <div className={styles.project__tileTextWrapper}>
              <h3 className={styles.project__tileName}>
